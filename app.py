...
st.markdown(
    """
    <style>
    .main-title { font-size: 36px; font-weight: bold; text-align: center; }
...
# Header #
# -------------------------------------------------- #
st.markdown("<div class='main-title'>Student AI Chatbot</div>", unsafe_allow_html=True)
st.markdown("<div class='subtitle'>Your AI-powered learning assistant</div>", unsafe_allow_html=True)
        ...
        st.session_state.messages = [
            {
                "role": "system",
                "content": (
                    "You are an expert Student AI Tutor. Your job is to help students learn concepts clearly.\n"
                    "Rules:\n"
